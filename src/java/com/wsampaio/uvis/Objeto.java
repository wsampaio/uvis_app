 ...
 */
package com.wsampaio.uvis;

import com.wsampaio.jdbc.ObjTable;

public class Objeto extends ObjTable{
	public Objeto(){
		setAttributes();
	}
	...
	public void setAttributes(){
		...
		setSQLStatement(
			...
			"SELECT " +
				...
				"FROM " +
					"objetos " +
						"RIGHT JOIN tipos_objetos " +
							"ON tipos_objetos.cod_tipo_objeto = objetos.cod_tipo_objeto " +
						"RIGHT JOIN modelos " +
							"ON modelos.cod_modelo = objetos.cod_modelo " +
						"RIGHT JOIN marcas " +
							"ON marcas.cod_marca = modelos.cod_marca " +
				"ORDER BY " +
					"tipos_objetos.tipo_objeto " +
					"& ' ' & " +
					"marcas.marca " +
